...
def simulate_journey(producer,device_id):
    while True:
        ...
        if vehicle_data['location'][0]>=DESTINATION.get_latitude() and vehicle_data['location'][1]>=DESTINATION.get_longitude():
            print('Vehicle has reached Destination. Simulation Ended..')
            break
